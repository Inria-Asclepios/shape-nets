...
def build_laplace_betrami_matrix(mesh):
...
def build_cotangens_matrix(mesh):
...
def build_mesh_laplace_matrix(mesh):
...
def build_laplace_approximation_matrix(mesh,
                                       approx='beltrami'
                                       ):
    """Build the sparse mesh laplacian matrix of the given mesh M=(V, E).
    This is a positive semidefinite matrix C:
...
def get_laplace_operator_approximation(mesh,
                                       approx='cotangens'
                                       ):
